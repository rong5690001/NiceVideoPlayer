...
//
//
//public interface FitMediaPlayer {
//    /*
...
//        void onPrepared(FitMediaPlayer mp);
//    }
//
//    interface OnCompletionListener {
//        void onCompletion(FitMediaPlayer mp);
//    }
//
//    interface OnBufferingUpdateListener {
//        void onBufferingUpdate(FitMediaPlayer mp, int percent);
//    }
//
//    interface OnSeekCompleteListener {
//        void onSeekComplete(FitMediaPlayer mp);
//    }
//
//    interface OnVideoSizeChangedListener {
//        void onVideoSizeChanged(FitMediaPlayer mp, int width, int height,
//                                int sar_num, int sar_den);
//    }
//
//    interface OnErrorListener {
//        boolean onError(FitMediaPlayer mp, int what, int extra);
//    }
//
//    interface OnInfoListener {
//    interface OnInfoListener {
//        boolean onInfo(FitMediaPlayer mp, int what, int extra);
//    }
//
//    /*--------------------
//     * Optional
